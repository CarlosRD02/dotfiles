...
#  user          # nombre de usuario
  ...
  azure
  conda
  exec_time     # tiempo de ejecución del último comando
#  async
  jobs
  sudo  
  line_sep
...
SPACESHIP_USER_SHOW=always          # siempre mostrar usuario
SPACESHIP_PROMPT_ADD_NEWLINE=false # no agregar línea nueva antes del prompt
SPACESHIP_CHAR_SYMBOL="❯"           # símbolo del prompt
